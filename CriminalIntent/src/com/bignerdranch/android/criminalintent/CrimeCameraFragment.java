	...
	private Camera.PictureCallback mJpegCallback = new Camera.PictureCallback() {
		...
		public void onPictureTaken(byte[] data, Camera camera) {
			...
			if (success) {
				...
				Intent communicateFileLocation = new Intent();
				communicateFileLocation.putExtra(EXTRA_PHOTO_FILENAME, filename);
				getActivity().setResult(Activity.RESULT_OK, communicateFileLocation);
			} else {
